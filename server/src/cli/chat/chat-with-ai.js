...
let _aiService, _chatService;
function getAIService() { return _aiService ??= new AIService(); }
function getChatService() { return _chatService ??= new ChatService(); }
...
async function getAIResponse(conversationId) {
    ...
    try {
        const result = await getAIService().sendMessage({
            message: aiMessages, onChunk: (chunk) => {
